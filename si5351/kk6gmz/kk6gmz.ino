...
// Here you put in your beacon message.
char message[ ] = "KK6GMZ KK6GMZ KK6GMZ CM87VJ CM87VJ // SI5351 BEACON //";

int calvalue = 14;// here you set the cal value for the TCXO

unsigned long int frequency = 5000000 ; // here you set the beacon nominal frequency

long tonetime = 3000; // Here you set the continuous tone time.
...
void setup() {
  ...
  si5351.set_correction(calvalue, SI5351_PLL_INPUT_XO);
  si5351.output_enable(SI5351_CLK0, 0);
